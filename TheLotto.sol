...
88  `"YbbdP"'   "Y888   "Y888 `"Ybbd8"' 88             Y88'     
    ...
    The Lotto is a charity token.
    10% tax on every transaction
    2% of every transacion is converted to BNB and sent to a donation wallet (wallet address:0x9A7d688749bD6c1F232D648DfB3C5A5c59f9a7bc)
    4% of every transaction is redistributed between holders of the coin
    4% of every transacion is burned
...
contract TheLotto is Context, IERC20, Ownable {
    ...
    string private _name = "The Lotto";
    ...
    address payable public charityAddress = 0x9A7d688749bD6c1F232D648DfB3C5A5c59f9a7bc;
